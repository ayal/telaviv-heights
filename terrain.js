...
zeropoint = {x: -10000, z: -10000, y: 1000}
	...
	var translate = function (lat, lng) {
	    ...
	    worldz = -10000 + (delta_lat / (32.120765 - (32.120765 - 255 * 0.0003339453125))) * 20000;
	    worldx = -10000 + (delta_lng / (34.828637 - 34.743147)) * 20000;
	...
	function onDocumentMouseDown( event ) {
		...
		window.open('http://activities.co.il/event/' + intersects[ 0 ].object.yoosh.MongoEventId,"source", "width=500, height=500");
		event.preventDefault();
		return false;
